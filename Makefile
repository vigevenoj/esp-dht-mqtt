...
SDK_BASE	?= /Volumes/case-sensitive/sdk

#Esptool.py path and port
ESPTOOL		?= /Volumes/case-sensitive/esptool/esptool.py
...
USER_MODULES		= dhtxx easygpio mqtt/mqtt mqtt/modules user
USER_INC				= include localinclude mqtt/include
USER_LIB				=

# which modules (subdirectories) of the project to include when compiling as library
LIB_MODULES			= mqtt/mqtt
...
ifneq ("$(wildcard $(THISDIR)/mqtt/include/user_config.local.h)","")
